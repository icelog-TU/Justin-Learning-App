...
| 7 | 鄭人買履 | `07-guwen-zhengrenmailv-decoder-content.md` | 第 1–20 題已依 Claude 初審完成 Markdown v1 格式遷移、讀音與出處核對修訂，全部維持草稿待審；白話驗證卷軸與徽章收尾仍沿用原核准版本；正式 App 不變 | 交回 Claude 複審本輪格式、讀音與出處核對修訂；複審完成後再交使用者人工審核 |
| 8 | 長竿入城 | `08-guwen-changganrucheng-decoder-content.md` | 新版任務開場、第 1–20 題、白話驗證卷軸與徽章均為待審草稿；第 2、3、6、8、9、11 題已依 Claude 初審修訂 | 將第 2、3、6、8、9、11 題交回 Claude 複審 |
