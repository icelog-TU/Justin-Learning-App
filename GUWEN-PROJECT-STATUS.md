...
| 10 | 自相矛盾 | `10-guwen-zixiangmaodun-decoder-content.md` | Active 新版任務開場、第 1～20 題、白話驗證卷軸與徽章收尾均已完成雙重 AI 審核，並經使用者以成人預覽 App 人工測試通過，全文核准；尚未轉入正式 App | 已完成 | 已完成（成人預覽 App 人工測試） | 尚未上線 | 等待建置並上線至正式 App |
