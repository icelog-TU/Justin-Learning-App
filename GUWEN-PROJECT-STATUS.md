...
| 6 | 掩耳盜鐘 | `06-guwen-yanerdaozhong-decoder-content.md` | 新版任務開場、第 1–20 題、白話驗證卷軸、完成鼓勵與徽章收尾均已完成雙重 AI 審核及使用者人工成人預覽 APP 測試，全文核准；Active 新版尚未同步正式 App | 已完成 | 已完成（成人預覽 App 測試） | 舊版已上線；Active 新版尚未上線 | 將 Active 最新核准版建置更新至正式 App |
