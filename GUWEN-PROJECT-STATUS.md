...
| 11 | 愚人食鹽 | `11-guwen-yurenshiyan-decoder-content.md` | Active 新版任務開場、第 1～21 題、白話驗證卷軸與徽章收尾均已完成雙重 AI 審核，並經使用者以成人預覽 App 人工審核通過，全文核准；已轉入正式 App，等待 GitHub Pages 部署驗收 | 已完成 | 已完成（成人預覽 App 人工審核） | Active 最新核准版已接入，等待部署驗收 | 等待 GitHub Pages 部署完成並核對正式站版本 |
| 12 | 疑鄰竊斧 | `12-guwen-yilinqiefu-decoder-content.md` | 定本、分句與 20 題藍圖已由使用者核准；任務開場、第 1～20 題、白話驗證卷軸與徽章收尾草稿已完成；已完成一輪獨立 AI 全文審稿；使用者已人工核准第 1～6 題；第 7～9、11 題已依人工意見修訂後待複審，全文尚未核准 | 未完成（已完成一輪獨立 AI 全文審稿並修訂，待複審） | 未完成（第 1～6 題已通過成人預覽 App 人工審核） | 尚未上線 | 使用成人預覽 App 複審第 7～9、11 題，之後繼續逐題人工審核 |
