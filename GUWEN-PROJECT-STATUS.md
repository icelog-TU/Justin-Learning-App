...
| 11 | 愚人食鹽 | `11-guwen-yurenshiyan-decoder-content.md` | 已完成一輪獨立 AI 全文審稿；使用者已人工核准第 1～14 題；第 15 題已改為詢問第二段想法是否有證據，第 16 題已精簡 App 引導語，第 17 題已移除引導語洩漏並補足第一條線索的平行結構，均待複審 | 未完成（已完成一輪獨立 AI 全文審稿並修訂） | 未完成（第 1～14 題已通過成人預覽 App 人工審核） | 尚未上線 | 使用成人預覽 App 複審第 15～17 題，之後繼續逐題人工審核 |
