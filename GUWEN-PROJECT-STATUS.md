...
| 11 | 愚人食鹽 | `11-guwen-yurenshiyan-decoder-content.md` | 已完成一輪獨立 AI 全文審稿；使用者已人工核准第 1～17 題；第 17 題已將較短線索移到前面；第 18 題已移除引導語洩漏並重寫兩條具完整前後文的線索，待複審；第 20 題已依使用者要求移除整串順序單選，改為六張可拖曳事件卡 | 未完成（已完成一輪獨立 AI 全文審稿並修訂） | 未完成（第 1～17 題已通過成人預覽 App 人工審核；第 20 題拖曳互動待預覽確認） | 尚未上線 | 使用成人預覽 App 複審第 18、20 題，之後繼續逐題人工審核 |
| 12 | 疑鄰竊斧 | `12-guwen-yilinqiefu-decoder-content.md` | 定本、分句與 20 題藍圖已由使用者核准；任務開場、第 1～20 題、白話驗證卷軸與徽章收尾草稿已完成；已完成一輪獨立 AI 全文審稿；使用者已人工核准第 1～6 題；第 7 題已依人工意見修正白話括號範圍，第 8 題已移除引導語答案洩漏並重寫為具足夠前因後果的低負擔線索，兩題均待複審，全文尚未核准 | 未完成（已完成一輪獨立 AI 全文審稿並修訂，待複審） | 未完成（第 1～6 題已通過成人預覽 App 人工審核） | 尚未上線 | 使用成人預覽 App 複審第 7、8 題，之後繼續逐題人工審核 |
