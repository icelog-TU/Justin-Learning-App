...
| 14 | 鷸蚌相爭 | `14-guwen-yubangxiangzheng-decoder-content.md` | 篇目與 20 題藍圖已由使用者核准；Active 主檔全文草稿已完成；全文已完成雙重 AI 審核並進入使用者成人預覽逐題審核；第 1～7 題已依第一輪人工意見補強【方】線索、修正【曝】白話並後移【出曝】畫面題，待使用者複審 | 已完成（雙重 AI 審核後，Q1～Q7 另依人工意見修訂） | 未完成（人工審核進行中） | 尚未上線 | 由使用者複審第 1～7 題修訂，之後繼續成人預覽逐題人工審核；全文明確核准後再更新鑰匙庫並交付正式 App 實作 |
