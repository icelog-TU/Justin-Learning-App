...
| 6 | 掩耳盜鐘 | `06-guwen-yanerdaozhong-decoder-content.md` | 新版 20 題藍圖已核准並完成全篇草稿；已完成第一輪 Claude Code 獨立 AI 審稿意見修訂；第 1–5 題及第 7–12 題已核准，第 6 題、開場、第 13–20 題與收尾待審；正式 App 維持既有版本 | 未完成（已完成一輪獨立 AI 審稿並修訂，待複審） | 未完成（僅部分題目已核准） | 舊版已上線；Active 新版尚未上線 | 交由 Claude Code 複審本輪修訂，再由使用者進行人工成人預覽審核 |
...
| 10 | 自相矛盾 | `10-guwen-zixiangmaodun-decoder-content.md` | 依核准藍圖完成任務開場、第 1–20 題、白話驗證卷軸與徽章收尾的全文草稿；全部待審，尚未核准 | 未完成（全部待審） | 未完成 | 尚未上線 | 交由 Claude Code 全文審稿，再依審稿意見修訂後交使用者人工審核 |
