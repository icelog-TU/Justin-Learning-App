...
| 11 | 愚人食鹽 | `11-guwen-yurenshiyan-decoder-content.md` | 已完成一輪獨立 AI 全文審稿；使用者已人工核准第 1～5、7～11 題；第 6 題已修正為「找出誰嫌口味太淡」，第 12、13 題已補足線索前後文並移除引導語洩漏，均待複審 | 未完成（已完成一輪獨立 AI 全文審稿並修訂） | 未完成（第 1～5、7～11 題已通過成人預覽 App 人工審核） | 尚未上線 | 使用成人預覽 App 複審第 6、12、13 題，之後繼續逐題人工審核 |
| 12 | 疑鄰竊斧 | `12-guwen-yilinqiefu-decoder-content.md` | 定本、分句與 20 題藍圖已由使用者核准；任務開場、第 1～20 題、白話驗證卷軸與徽章收尾草稿已完成；已完成一輪獨立 AI 全文審稿，並依審稿意見修正正解位置核對及補明第 7 題線索卷次與連結，修訂內容待複審，全文尚未核准 | 未完成（已完成一輪獨立 AI 全文審稿並修訂，待複審） | 未完成（待使用者成人預覽 App 人工審核） | 尚未上線 | 將本輪修訂段落送交另一個 AI 複審 |
