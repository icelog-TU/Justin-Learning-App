...
| 9 | 楊氏之子 | `09-guwen-yangshizi-decoder-content.md` | Active 新版任務開場、第 1–20 題、白話驗證卷軸與徽章收尾均已完成雙重 AI 審核，並經使用者以成人預覽 App 人工檢驗合格，全文核准；Active 最新核准版已接入正式 App，待 GitHub Pages 部署驗收 | 已完成 | 已完成（成人預覽 App 人工檢驗） | Active 最新核准版已接入正式 App | 依正式 App 線上驗收與實際使用回饋調整 |
| 10 | 自相矛盾 | `10-guwen-zixiangmaodun-decoder-content.md` | 全文草稿已完成一輪獨立 AI 全文審稿；2026-07-30 已依使用者首輪人工回饋修訂線索可推理性、核心邏輯與全文證據題，全部仍待核准 | 未完成（已完成一輪獨立 AI 全文審稿並修訂） | 未完成（已進入逐題人工審核，本輪修訂待複審） | 尚未上線 | 使用成人預覽 App 複審本輪修訂，並繼續逐題人工審核 |
| 11 | 愚人食鹽 | `11-guwen-yurenshiyan-decoder-content.md` | 已完成一輪獨立 AI 全文審稿；使用者已核准第 1、2、5 題；2026-07-30 已依人工回饋精簡第 3、7、8 題，重寫第 4 題【益】與第 9～10 題句式線索，全部修改後內容仍待複審 | 未完成（已完成一輪獨立 AI 全文審稿並修訂） | 未完成（已開始使用成人預覽 App 人工審核；第 1、2、5 題已核准） | 尚未上線 | 使用成人預覽 App 複審第 3、4、7～10 題，之後繼續逐題人工審核 |
