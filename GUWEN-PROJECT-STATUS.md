...
| 14 | 鷸蚌相爭 | `14-guwen-yubangxiangzheng-decoder-content.md` | 篇目與 20 題藍圖已由使用者核准；Active 主檔全文草稿已完成；第一輪獨立 AI 審稿列管的 Q2／Q7／Q12／Q16／Q18 已修訂並經 Claude 複審確認，Q17《左傳》原段另經 GPT 逐字核對成立；全文已完成雙重 AI 審核，尚待使用者成人預覽逐題核准 | 已完成 | 未完成 | 尚未上線 | 由使用者以成人預覽 App 逐題人工審核；全文明確核准後再更新鑰匙庫並交付正式 App 實作 |
