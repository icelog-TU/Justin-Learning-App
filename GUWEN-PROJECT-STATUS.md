...
| 7 | 鄭人買履 | `07-guwen-zhengrenmailv-decoder-content.md` | 第 1–14、16–20 題已由使用者人工核准；第 15 題原線索二使用本篇前後文形成自證，已改用兩條獨立外部古文線索，修訂版待使用者複核；白話驗證卷軸與徽章收尾沿用原核准版本；正式 App 不變 | 請使用者複核第 15 題修訂版；通過後完成新版全篇教材核准 |
