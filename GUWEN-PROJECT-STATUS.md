...
| 11 | 愚人食鹽 | `11-guwen-yurenshiyan-decoder-content.md` | 已完成一輪獨立 AI 全文審稿；使用者已人工核准第 1～17 題；第 17 題已將較短線索移到前面；第 18 題已移除引導語洩漏並重寫兩條具完整前後文的線索，待複審 | 未完成（已完成一輪獨立 AI 全文審稿並修訂） | 未完成（第 1～17 題已通過成人預覽 App 人工審核） | 尚未上線 | 使用成人預覽 App 複審第 18 題，之後繼續逐題人工審核 |
