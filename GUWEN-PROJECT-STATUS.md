...
| 11 | 愚人食鹽 | `11-guwen-yurenshiyan-decoder-content.md` | 已完成一輪獨立 AI 全文審稿；使用者已人工核准第 1～11 題；第 12、13 題已依人工意見更換低負擔線索並以括號標示補充前情，均待複審 | 未完成（已完成一輪獨立 AI 全文審稿並修訂） | 未完成（第 1～11 題已通過成人預覽 App 人工審核） | 尚未上線 | 使用成人預覽 App 複審第 12、13 題，之後繼續逐題人工審核 |
| 12 | 疑鄰竊斧 | `12-guwen-yilinqiefu-decoder-content.md` | 定本、分句與 20 題藍圖已由使用者核准；任務開場、第 1～20 題、白話驗證卷軸與徽章收尾草稿已完成；已完成一輪獨立 AI 全文審稿；使用者已人工核准第 1～3 題；第 4、5、7 題已依人工意見更換或簡化低負擔線索，修訂後待複審，全文尚未核准 | 未完成（已完成一輪獨立 AI 全文審稿並修訂，待複審） | 未完成（第 1～3 題已通過成人預覽 App 人工審核） | 尚未上線 | 使用成人預覽 App 複審第 4、5、7 題，之後繼續逐題人工審核 |
| 13 | 曹沖稱象 | `13-guwen-caochongchengxiang-decoder-content.md` | 篇目、定本、分句與 20 題藍圖已由使用者核准；任務開場、第 1～20 題、白話驗證卷軸與徽章收尾草稿已完成，全文尚待另一個 AI 審稿 | 未完成（待另一個 AI 全文審稿） | 未完成 | 尚未上線 | 交由另一個 AI 全文審稿，依審稿意見修訂 |
