...
| 7 | 鄭人買履 | `07-guwen-zhengrenmailv-decoder-content.md` | 第 1–14 題及第 16–20 題已由使用者人工核准；第 15 題已依使用者意見改為先比較兩條線索中「得」的不同意思，再於核心解答扣回原文，修訂稿待審；白話驗證卷軸與徽章收尾維持原核准狀態；正式 App 不變 | 請使用者人工審核修訂後的第 15 題；核准後再另行決定是否更新正式 App |
| 8 | 長竿入城 | `08-guwen-changganrucheng-decoder-content.md` | 新版任務開場、第 1–20 題、白話驗證卷軸與徽章均為待審草稿；第 3、6、11 題原典來源已完成補強與核實；第 10、11、15、17 題已依使用者意見改為前情完整、具象、低負擔的混種線索 | 請使用者人工審核修訂後的第 10、11、15、17 題 |
