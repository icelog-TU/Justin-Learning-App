...
| 9 | 楊氏之子 | `09-guwen-yangshizi-decoder-content.md` | Active 新版任務開場、第 1–20 題、白話驗證卷軸與徽章收尾均已完成雙重 AI 審核，並經使用者以成人預覽 App 人工檢驗合格，全文核准；尚未轉入正式 App | 已完成 | 已完成（成人預覽 App 人工檢驗） | 尚未上線 | 等待建置並上線至正式 App |
| 10 | 自相矛盾 | `10-guwen-zixiangmaodun-decoder-content.md` | Active 新版任務開場、第 1～20 題、白話驗證卷軸與徽章收尾均已完成雙重 AI 審核，並經使用者以成人預覽 App 人工測試通過，全文核准；Active 最新核准版已接入正式 App，待 GitHub Pages 部署驗收 | 已完成 | 已完成（成人預覽 App 人工測試） | Active 最新核准版已接入正式 App | 完成 GitHub Pages 部署與正式 App 線上驗收 |
