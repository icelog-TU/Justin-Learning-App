...
| 11 | 愚人食鹽 | `11-guwen-yurenshiyan-decoder-content.md` | 已完成一輪獨立 AI 全文審稿；依使用者人工審查調整第 3～6 題順序，並修正第 3 題【聞已】線索提前洩露答案；修改後內容仍待複審，尚未核准 | 未完成（已完成一輪獨立 AI 全文審稿並修訂） | 未完成（已開始使用成人預覽 App 人工審核；第 3～6 題修改後待複審） | 尚未上線 | 使用成人預覽 App 複審第 3～6 題，之後繼續逐題人工審核 |
