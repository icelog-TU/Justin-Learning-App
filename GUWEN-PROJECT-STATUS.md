...
| 8 | 長竿入城 | `08-guwen-changganrucheng-decoder-content.md` | 第 11 題已核准；新版任務開場、第 1–10 題、第 12–20 題、白話驗證卷軸與徽章仍為待審草稿；第 3、6 題及第 11 題原典來源已完成補強與核實；第 10 題白話線索再次降低理解負擔，第 15 題改為破解「截」 | 請使用者人工審核修訂後的第 10、15 題 |
