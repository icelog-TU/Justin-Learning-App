...
| 6 | 掩耳盜鐘 | `06-guwen-yanerdaozhong-decoder-content.md` | 新版 20 題藍圖已核准並完成全篇草稿；第 1–5 題及第 7–12 題已核准，第 6 題、開場、第 13–20 題與收尾待審；正式 App 維持既有版本 | 未完成（待全篇獨立 AI 審稿） | 未完成（僅部分題目已核准） | 舊版已上線；Active 新版尚未上線 | 交由 Claude Code 進行全篇獨立 AI 審稿，再依審稿意見修訂 |
