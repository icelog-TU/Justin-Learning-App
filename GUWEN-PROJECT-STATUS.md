...
| 12 | 疑鄰竊斧 | `12-guwen-yilinqiefu-decoder-content.md` | Active 新版任務開場、第 1～20 題、白話驗證卷軸與徽章收尾均已完成雙重 AI 審核，並經使用者以成人預覽 App 人工審核通過，全文核准；等待轉入正式 App | 已完成 | 已完成（成人預覽 App 人工審核） | 尚未上線 | 將 Active 最新核准版轉入正式 App |
