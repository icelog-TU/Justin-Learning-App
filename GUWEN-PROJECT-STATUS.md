...
| 7 | 鄭人買履 | `07-guwen-zhengrenmailv-decoder-content.md` | 新版任務開場、第 1–20 題、白話驗證卷軸與徽章收尾均已完成雙重 AI 審核，並經使用者以成人預覽 App 人工審核通過，全文核准並同步正式 App | 已完成 | 已完成（成人預覽 App 人工審核） | Active 最新核准版已上線 | 依實際使用回饋調整 |
| 8 | 長竿入城 | `08-guwen-changganrucheng-decoder-content.md` | 新版任務開場、第 1–20 題、白話驗證卷軸與徽章收尾均已完成雙重 AI 審核，並經使用者以成人預覽 App 人工審核通過，全文核准並同步正式 App | 已完成 | 已完成（成人預覽 App 人工審核） | Active 最新核准版已上線 | 依實際使用回饋調整 |
| 9 | 楊氏之子 | `09-guwen-yangshizi-decoder-content.md` | Active 新版任務開場、第 1–20 題、白話驗證卷軸與徽章收尾均已完成雙重 AI 審核，並經使用者以成人預覽 App 人工檢驗合格，全文核准；Active 最新核准版已同步正式 App 並完成上線 | 已完成 | 已完成（成人預覽 App 人工檢驗） | Active 最新核准版已上線 | 依實際使用回饋調整 |
| 10 | 自相矛盾 | `10-guwen-zixiangmaodun-decoder-content.md` | Active 新版任務開場、第 1～20 題、白話驗證卷軸與徽章收尾均已完成雙重 AI 審核，並經使用者以成人預覽 App 人工測試通過，全文核准；Active 最新核准版已同步正式 App 並完成 GitHub Pages 線上驗收 | 已完成 | 已完成（成人預覽 App 人工測試） | Active 最新核准版已上線 | 依正式 App 實際使用回饋調整 |
| 11 | 愚人食鹽 | `11-guwen-yurenshiyan-decoder-content.md` | Active 新版任務開場、第 1～21 題、白話驗證卷軸與徽章收尾均已完成雙重 AI 審核，並經使用者以成人預覽 App 人工審核通過，全文核准；Active 最新核准版已同步正式 App 並完成 GitHub Pages 線上驗收 | 已完成 | 已完成（成人預覽 App 人工審核） | Active 最新核准版已上線 | 依正式 App 實際使用回饋調整 |
| 12 | 疑鄰竊斧 | `12-guwen-yilinqiefu-decoder-content.md` | Active 新版任務開場、第 1～20 題、白話驗證卷軸與徽章收尾均已完成雙重 AI 審核，並經使用者以成人預覽 App 人工審核通過，全文核准；Active 最新核准版已同步正式 App 並完成 GitHub Pages 線上驗收 | 已完成 | 已完成（成人預覽 App 人工審核） | Active 最新核准版已上線 | 依正式 App 實際使用回饋調整 |
| 13 | 曹沖稱象 | `13-guwen-caochongchengxiang-decoder-content.md` | 篇目、定本、分句與 20 題藍圖已由使用者核准；任務開場、第 1～20 題、白話驗證卷軸與徽章收尾草稿已完成；已完成一輪獨立 AI 全文審稿，並依審稿意見統一數字選項、補強 Q3／Q5／Q6／Q19 出處，全文尚待複審與使用者逐題核准 | 未完成（已完成一輪獨立 AI 全文審稿並修訂，待複審） | 未完成 | 尚未上線 | 交由另一個 AI 複審本輪選項格式與 Q3／Q5／Q6／Q19 來源修訂，之後進入成人預覽 App 逐題審核 |
| 14 | 鷸蚌相爭 | `14-guwen-yubangxiangzheng-decoder-content.md` | 篇目與 20 題藍圖已由使用者核准；Active 主檔全文草稿已建立；已完成一輪獨立 AI 全文審稿，並依審稿意見補強 Q2／Q17 出處、重寫 Q7、分散 Q12 線索來源、替換 Q16 線索及收斂 Q18 作答前提示；全文尚待複審與使用者逐題核准 | 未完成（已完成一輪獨立 AI 全文審稿並修訂，待複審） | 未完成 | 尚未上線 | 交由另一個 AI 複審本輪 Q2／Q7／Q12／Q16／Q17／Q18 修訂，之後進入成人預覽 App 逐題審核 |
