...
| 9 | 楊氏之子 | `09-guwen-yangshizi-decoder-content.md` | 重寫時間線已重啟；新版開場與第 1–20 題已完成獨立 AI 全文審稿並依意見修訂；第 13–14 題已通過使用者人工審核，其餘仍待審 | 未完成（已完成一輪獨立 AI 全文審稿並修訂） | 未完成（第 13–14 題已完成；其餘待使用者逐題人工審核） | 尚未上線 | 使用成人預覽 App 繼續逐題人工審核第 1–12、15–20 題 |
...
| 11 | 愚人食鹽 | `11-guwen-yurenshiyan-decoder-content.md` | 已完成一輪獨立 AI 全文審稿，並依審稿意見修訂第 2、4、6、12、13、16、21 題；全篇仍待使用者人工審核，尚未核准 | 未完成（已完成一輪獨立 AI 全文審稿並修訂） | 未完成（待使用者成人預覽 App 人工審核） | 尚未上線 | 使用成人預覽 App 逐題人工審核 |
