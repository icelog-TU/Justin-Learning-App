...
export const yanErDaoZhongLesson: GuwenLesson = {
  ...
  steps: [
    ...
    },
    {
      ...
      intro:
        '🔑「欲」在這裡表示想要。🔑「負」表示把東西放在背上背著。🔑「走」表示跑、跑開。所以「欲負而走」已經破解為：他想把鐘背起來，再帶著鐘跑開。\n\n「得鐘」很容易讓人以為：這個人已經得手，甚至把鐘帶回家了。可是下一句又寫他「欲負而走」。這兩句似乎衝突了？我們用後一句反查前一句。',
      ...
      correctIndex: 0,
      correctFeedback: '前後文接起來了！這裡的「得鐘」表示他發現、找到了一口鐘，不表示他已經把鐘搬走。下一句「欲負而走」才寫出：他接著想把鐘背起來，帶離原處。',
