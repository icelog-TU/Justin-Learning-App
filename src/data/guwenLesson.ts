...
export const wangRongLesson: GuwenLesson = {
  ...
  steps: [
      ...
      clues: [
        {
          text: '子壓枝折。',
          highlight: '子壓枝折',
          // 故意不給白話翻譯：這條線索要考的正是「子壓枝折」和「多實壓枝」共同呈現的「數量多的東西壓在枝上」這個
          // 位置/因果關係本身，翻成白話等於直接告訴孩子「壓著」「因此彎折」，等於把答案說出來了。
          source: '《太平御覽．人事部二十六．幼智下》',
        },
        {
          text: '葡萄多實壓枝。',
          highlight: '多實壓枝',
          // 故意不給白話翻譯，理由同上一條——「實」是葡萄的果實，孩子要自己比較兩條線索才能看出「多X壓/折Y」的排列。
    ...
    },
    {
      ...
      clues: [
        {
          text: '友人慚，下車引之。',
          highlight: '之',
          // 開頭括號補充「友人慚」的前情（父親的朋友不守時、被元方斥責），讓孩子讀懂這句在演什麼；但故意不點名
          // 「之」指的是誰（不加「（元方）」這種直接解答的括號）——這條線索要考的正是「之」不重新寫出對象、要
          // 孩子自己回頭到前文推論的這個特性本身，直接說出「元方」等於把答案說出來了。
          unlockedMeaning: '（父親的朋友不守時，元方義正言辭地斥責他。）父親的友人感到慚愧，下車拉住了「之」。',
          source: '劉義慶《世說新語．方正》',
        },
        {
          text: '屠暴起，以刀劈狼首，又數刀斃之。',
      ...
      question: '兩條線索裡，「之」後面都沒有再寫出要指的對象是誰。「之」在這兩句中做了什麼？',
...
export const yaMiaoZhuZhangLesson: GuwenLesson = {
  ...
  steps: [
    ...
    },
    {
      ...
      intro:
        '🔑「其」以前已經破解過：它會把後面的東西連回前面提到的人。簡單說，「其苗」就是「他的苗」，也就是這位宋國人的禾苗。🔑 第一題剛取得「之」的新鑰匙：它可以把前面的主角和後面的情況接在一起。所以「苗之不長」就是「禾苗沒有長高這件事」。這個人看著自己的禾苗一直沒有長高，古文說他「閔」。他當時是什麼心情？比較兩條古文線索看看。',
      clues: [
        {
    ...
    },
    {
      ...
      targetSentence: '揠之',
      intro:
        '🔑「之」的舊鑰匙：它可以指回前面出現的人或東西。這裡「揠之」的「之」，指的就是前面的禾苗。可是，這個人究竟對禾苗做了什麼？我找到一條古文線索和一條結構對照句，我們來比較「揠」完成後，東西的位置發生了什麼變化。',
      clues: [
        {
    ...
    },
    {
      ...
      targetSentence: '謂其人曰',
      intro:
        '🔑「其」以前已經破解過：它會把後面的東西連回前面的人。這裡的「其人」指這位宋人的家人。🔑「曰」也已經破解過：表示說、開口說話。現在只剩中間的「謂」還沒破解。它夾在兩個人名中間，究竟在安排什麼關係？比較兩條古文線索看看。',
      clues: [
        {
    ...
    },
    {
      ...
      targetSentence: '今日病矣',
      intro:
        '🔑「矣」以前已經破解過：它提醒我們，前面的情況現在已經出現。簡單說，「病矣」就是「現在已經病了」。可是，宋人說的「病」真的是生病嗎？先比較他人兩次做了很多事情之後出現的「病」。',
      clues: [
        {
          text: '且不得暇，故病且怠。',
          highlight: '病',
      ...
      clues: [
        {
          text: '見物則爭趨之。',
          highlight: '趨',
          unlockedMeaning: '（一群不聽指揮的士兵看見東西，便和搶栗子的猴子一樣亂成一團。）他們一看見東西，就爭著「趨」過去。',
          source: '劉基《郁離子・僰人養猴》',
        },
        {
    ...
    },
    {
      ...
      targetSentence: '其子趨而往視之',
      intro:
        '🔑「往」以前已經破解過：離開原處，到另一個地方。🔑「之」會指回前面的人或東西。兒子到了那裡，接著做的「視」是什麼？',
      clues: [
        {
