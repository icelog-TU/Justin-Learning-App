...
export const simaGuangLesson: GuwenLesson = {
  ...
  steps: [
      ...
      clues: [
        {
          text: '登高而招。',
          highlight: '登',
          unlockedMeaning: '爬到高處揮手。',
          source: '《荀子．勸學》',
        },
        {
          text: '登泰山而小天下。',
          highlight: '登',
          unlockedMeaning: '爬上泰山後，覺得天下都變小了。',
          source: '《孟子．盡心上》',
        },
      ],
      question: '比較兩條古文線索，「登」最可能表示哪一個動作？',
      options: ['從高處跳下來', '向上爬到某個地方', '抱著東西走出去'],
      correctIndex: 1,
      correctFeedback: '破解成功！兩句中的人都從下面移動到了高處。',
      retryHint: '看看人最後到了哪裡：第一句到了高處，第二句到了泰山上。這個動作的方向是什麼？',
      explanation:
    ...
    },
    {
      id: 'zhong_jie_qi_qu',
      type: 'reconstruction',
      prerequisiteIds: ['qi_qu'],
      targetSentence: '眾皆棄去',
      intro: '「棄去」已經破解了。現在把「眾」和「皆」也放進來，看看有多少孩子離開。',
      keys: [
        { code: '眾', decodedEvidence: '在場的其他孩子們' },
    ...
    },
    {
      ...
      intro: '司馬光沒有跟著離開，而是「持石擊甕」。到底是拿石頭敲甕，還是拿甕敲石頭？句子的順序藏著線索。',
      clues: [
        {
          text: '人或持石擊地。',
          highlight: '持石擊地',
          unlockedMeaning: '有人做出「持石擊地」的動作後，地面傳出了特別的聲音。',
          source: '郎瑛《七修類稿》卷二。',
        },
        {
          text: '某歸聞之，怒，持杖擊之。',
          highlight: '持杖擊之',
          unlockedMeaning: '有人回來後很生氣，做出「持杖擊之」的動作；這裡的「之」指眼前的鬼。',
          source: '徐鉉《稽神錄》卷三。',
        },
      ],
      question: '比較兩條線索，「持Ａ擊Ｂ」的排列規則最可能是什麼？',
      options: ['拿著Ａ，去敲打Ｂ', '把Ａ和Ｂ都放在原地，不碰它們', '拿著Ｂ，去敲打Ａ'],
      correctIndex: 0,
      correctFeedback: '句型破解成功！「持」後面是工具，「擊」後面是目標。',
      retryHint: '在「持石擊地」裡，是石頭發出動作，還是地面被敲？先找出工具和目標的位置。',
      explanation:
