    ...
    <div className="space-y-4">
      ...
      <div className="space-y-3">
        {guwenTexts.map((text) => {
          ...
          return (
            <div key={text.id} className="bg-white rounded-2xl shadow hover:shadow-lg transition-shadow p-5">
              <Link to={`/guwen/${text.id}`} className="block">
              ...
              {decodedCount > 0 &&
                (confirmResetId === text.id ? (
                  ...
                  <div className="mt-3 pt-3 border-t border-gray-100">
                    <button
                      type="button"
                      onClick={() => setConfirmResetId(text.id)}
